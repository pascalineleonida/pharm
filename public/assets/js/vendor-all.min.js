!(function (e, t) {
    ...
    var C = (function (e) {
        ...
        try {
            W.apply((N = O.call(w.childNodes)), w.childNodes),
            ...
            if (
                ...
                if (11 !== T && (f = Z.exec(e)))
                    if ((o = f[1])) {
                        ...
                        if (f[2])
                            return W.apply(r, t.getElementsByTagName(e)), r;
                        if (
                            (o = f[3]) &&
                            n.getElementsByClassName &&
                            t.getElementsByClassName
                        )
                            return W.apply(r, t.getElementsByClassName(o)), r;
                    }
                if (
                    n.qsa &&
                    !k[e + " "] &&
            ...
            return (
                ...
                ce(function (o, s, a, l) {
                    var c,
                        ...
                        v = n ? (i || (o ? e : h || r) ? [] : s) : m;
                    if ((n && n(m, v, a, l), r))
                        for (c = Te(v, d), r(c, [], a, l), u = c.length; u--; )
                            (f = c[u]) && (v[d[u]] = !(m[d[u]] = f));
                    if (o) {
                        if (i || e) {
                            if (i) {
            ...
            function (e, t) {
                w.fn[e] = function (n, r) {
                    ...
                    return (
                        ...
                        1 < this.length &&
                            (O[e] || w.uniqueSort(i), W.test(e) && i.reverse()),
                        this.pushStack(i)
                    );
                };
            }
    ...
    (w.Callbacks = function (e) {
        ...
        w.extend({
                    ...
                    i = {
                        ...
                        then: function (t, r, i) {
                            ...
                            return w
                                .Deferred(function (e) {
                                    n[0][3].add(
                                        s(0, e, g(i) ? i : P, e.notifyWith)
                                    ),
                                        n[1][3].add(s(0, e, g(t) ? t : P)),
                                        n[2][3].add(s(0, e, g(r) ? r : q));
                                })
                                .promise();
                        },
                        promise: function (e) {
            ...
            when: function (e) {
                ...
                if (
                    t <= 1 &&
                    (Y(e, s.done(a(n)).resolve, s.reject, !t),
                    "pending" === s.state() || g(i[n] && i[n].then))
                )
                    return s.then();
                for (; n--; ) Y(i[n], a(n), s.reject);
                return s.promise();
            },
        });
                      ...
                      if (1 & e.isTrigger && this[t]) {
                          ...
                          s &&
                              (G.set(
                                  ...
                                  t,
                                  w.event.trigger(
                                      w.extend(s.shift(), w.Event.prototype),
                                      s,
                                      this
                                  )
                              ),
                ...
                for (c = (t = (t || "").match(M) || [""]).length; c--; )
                    if (
                        ...
                        s &&
                            ...
                            delete l[d]);
                    } else for (d in l) w.event.remove(e, d + t[c], n, r, !0);
    ...
    function qe(e, t, n, r) {
        ...
        var i,
            ...
            m = t[0],
            v = g(m);
        if (v || (1 < p && "string" == typeof m && !h.checkClone && je.test(m)))
        ...
        if (
            ...
            for (l = (a = w.map(me(i, "script"), Re)).length; f < p; f++)
                (c = i),
                    f !== d &&
                        ((c = w.clone(c, !0, !0)),
            ...
            if (l)
                for (
                    u = a[a.length - 1].ownerDocument, w.map(a, Me), f = 0;
                    f < l;
                    f++
                )
                    (c = a[f]),
    ...
    w.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (
                ...
                for (s = me(u), r = 0, i = (o = me(e)).length; r < i; r++)
                    (a = o[r]),
            ...
            if (t)
                if (n)
                    for (
                        o = o || me(e), s = s || me(u), r = 0, i = o.length;
                        r < i;
                        r++
                    )
                        Pe(o[r], s[r]);
    ...
    function et(e, t, n, r, i, o) {
        ...
        for (; s < 4; s += 2)
            "margin" === n && (l += w.css(e, n + re[s], !0, i)),
                r
                    ? ("content" === n &&
                          (l -= w.css(e, "padding" + re[s], !0, i)),
                      "margin" !== n &&
                          (l -= w.css(e, "border" + re[s] + "Width", !0, i)))
                    : ((l += w.css(e, "padding" + re[s], !0, i)),
                      "padding" !== n
                          ? (l += w.css(e, "border" + re[s] + "Width", !0, i))
                          : (a += w.css(e, "border" + re[s] + "Width", !0, i)));
        return (
            !r &&
                0 <= o &&
                (l +=
    ...
    (w.Animation = w.extend(dt, {
        ...
        (ot = r.createElement("input")),
        (st = r.createElement("select").appendChild(r.createElement("option"))),
        (ot.type = "checkbox"),
        (h.checkOn = "" !== ot.value),
        (h.optSelected = st.selected),
        ((ot = r.createElement("input")).value = "t"),
        (ot.type = "radio"),
            ...
            if (
                ...
                for (s = 0; (a = v[s++]) && !t.isPropagationStopped(); )
                    (h = a),
                        ...
                        (p =
                            (G.get(a, "events") || {})[t.type] &&
                            G.get(a, "handle")) && p.apply(a, n),
                        (p = u && a[u]) &&
                            p.apply &&
                            V(a) &&
                    ...
                    o ||
                        ...
                        (u &&
                            ...
                            t.isPropagationStopped() &&
                                h.addEventListener(y, Et),
                            i[y](),
                            t.isPropagationStopped() &&
                                h.removeEventListener(y, Et),
            ...
            ajax: function (t, n) {
                ...
                function S(t, n, r, a) {
                    ...
                    u ||
                        ...
                        (C.statusText = (n || E) + ""),
                        c
                            ? v.resolveWith(g, [p, E, C])
                            : v.rejectWith(g, [C, E, d]),
                        C.statusCode(b),
                        (b = void 0),
                        f &&
    ...
    w.ajaxSetup({
        ...
        (h.createHTMLDocument =
            (((zt = r.implementation.createHTMLDocument("").body).innerHTML =
                "<form></form><form></form>"),
        ...
        (w.fn.load = function (e, t, n) {
            var r,
                ...
                a = e.indexOf(" ");
            return (
                -1 < a && ((r = yt(e.slice(a))), (e = e.slice(0, a))),
                g(t)
                    ? ((n = t), (t = void 0))
    ...
    (function (e, t) {
        ...
        function i(e) {
            return 11 === e ? z : 10 === e ? V : z || V;
        }
        function o(e) {
            if (!e) return document.documentElement;
            for (
                var n = i(10) ? document.body : null,
        ...
        function a(e, t) {
            ...
            if ((e !== c && t !== c) || r.contains(i))
                return (function (e) {
                    ...
                    return (
                        "BODY" !== t &&
                        ("HTML" === t || o(e.firstElementChild) === e)
                    );
                })(c)
                    ? c
                    : o(c);
        ...
        function p(e) {
            ...
            return { height: f("Height", t, n, r), width: f("Width", t, n, r) };
        }
        function d(e) {
            return J({}, e, {
        ...
        function g(e, n) {
            ...
            o && a && ((u.top = I(u.top, 0)), (u.left = I(u.left, 0)));
            var v = d({
                top: l.top - u.top - g,
            ...
            return (
                (s && !o ? n.contains(f) : n === f && "BODY" !== f.nodeName) &&
                    (v = c(v, n)),
                v
            );
        }
        ...
        function b(e, t, i, o) {
            ...
            var x = "number" == typeof (i = i || 0);
            return (
                (l.left += x ? i : i.left || 0),
                (l.top += x ? i : i.top || 0),
                (l.right -= x ? i : i.right || 0),
                (l.bottom -= x ? i : i.bottom || 0),
                l
            );
        }
        function x(e) {
        ...
        function H(e, t, n, i) {
            (n.updateBound = i),
                N(e).addEventListener("resize", n.updateBound, { passive: !0 });
            var o = r(e);
            return (
                (function e(t, n, i, o) {
        ...
        for (
            ...
            if (B && 0 <= navigator.userAgent.indexOf(F[_])) {
                $ = 1;
                break;
            }
        var U =
            ...
            V = B && /MSIE 10/.test(navigator.userAgent),
            K = function (e, t) {
                if (!(e instanceof t))
            ...
            Z = B && /Firefox/i.test(navigator.userAgent),
            ee = [
                "auto-start",
                "auto",
                "auto-end",
            ...
            oe = (function () {
                function t(n, r) {
                    ...
                    K(this, t),
                        ...
                        Object.keys(
                            J({}, t.Defaults.modifiers, o.modifiers)
                        ).forEach(function (e) {
                            i.options.modifiers[e] = J(
                                {},
                        ...
                        (this.modifiers = Object.keys(this.options.modifiers)
                            .map(function (e) {
                                return J({ name: e }, i.options.modifiers[e]);
                            })
                            .sort(function (e, t) {
    ...
    (function (e, t) {
        ...
        function a(e, t) {
            v[t] = setTimeout(function () {
                return (
                    e.isAlive &&
                    e.element.classList.remove(m.state.scrolling(t))
                );
        ...
        function d(e, n) {
            ...
            n.isRtl
                ...
                n.isScrollbarXUsingBottom
                    ? (r.bottom = n.scrollbarXBottom - i)
                    : (r.top = n.scrollbarXTop + i),
        ...
        function h(e, t) {
            ...
            function r() {
                a(e, d),
                    e[h].classList.remove(m.state.clicking),
            ...
            e.event.bind(e[u], "mousedown", function (t) {
                (v = g[p]),
                    ...
                    e[h].classList.add(m.state.clicking),
                    t.stopPropagation(),
                    t.preventDefault();
            });
        }
        ...
        var w = function (e, t, n, r, i) {
                ...
                !(function (e, t, n, r, i) {
                    ...
                    var d = e.element;
                    (e.reach[u] = null),
                        d[a] < 1 && (e.reach[u] = "start"),
                        d[a] > e[o] - e[s] - 1 && (e.reach[u] = "end"),
                        t &&
            ...
            E = function (e) {
                ...
                (e.containerWidth = t.clientWidth),
                    ...
                    t.contains(e.scrollbarXRail) ||
                        (o(t, m.element.rail("x")).forEach(function (e) {
                            return i(e);
                        }),
                        t.appendChild(e.scrollbarXRail)),
                    t.contains(e.scrollbarYRail) ||
                        (o(t, m.element.rail("y")).forEach(function (e) {
                            return i(e);
                        }),
                    ...
                    d(t, e),
                    e.scrollbarXActive
                        ? t.classList.add(m.state.active("x"))
                        : (t.classList.remove(m.state.active("x")),
                          (e.scrollbarXWidth = 0),
                          (e.scrollbarXLeft = 0),
                          (t.scrollLeft = 0)),
                    e.scrollbarYActive
                        ? t.classList.add(m.state.active("y"))
                        : (t.classList.remove(m.state.active("y")),
            ...
            C = {
                ...
                wheel: function (t) {
                    function n(t, n, r) {
                        if (!T.isWebKit && i.querySelector("select:focus"))
                            return !0;
                        if (!i.contains(t)) return !1;
                        for (var o = t; o && o !== i; ) {
                            if (o.classList.contains(m.element.consuming))
                                return !0;
                            var s = e(o);
                            if (
                                    ...
                                    : t.scrollbarXActive &&
                                      ...
                                      (o
                                          ...
                                          : (i.scrollLeft -=
                                                s * t.settings.wheelSpeed),
                                      (a = !0))
                                : ((i.scrollTop -= s * t.settings.wheelSpeed),
                                  (i.scrollLeft += o * t.settings.wheelSpeed)),
                                E(t),
                                (a =
                                    a ||
                                    (function (e, n) {
                    ...
                    void 0 !== window.onwheel
                        ? t.event.bind(i, "wheel", r)
                        : void 0 !== window.onmousewheel &&
                          t.event.bind(i, "mousewheel", r);
                },
                touch: function (t) {
                    function n(e, n) {
                        ...
                        if (s > o) {
                            if (
                                ...
                                return (
                                    0 === window.scrollY && n > 0 && T.isChrome
                                );
                        } else if (
                            o > s &&
                            ((e < 0 &&
                                i === t.contentWidth - t.containerWidth) ||
                                (e > 0 && 0 === i))
                        )
                            return !0;
                        return !0;
                    ...
                    function r(e, n) {
                        (u.scrollTop -= n), (u.scrollLeft -= e), E(t);
                    }
                    function i(e) {
                    ...
                    function a(t, n, r) {
                        ...
                        for (var i = t; i && i !== u; ) {
                            if (i.classList.contains(m.element.consuming))
                                return !0;
                            var o = e(i);
                            if (
            ...
            S = function (r, i) {
                ...
                (this.isRtl = "rtl" === e(r).direction),
                    ...
                    (this.scrollbarXRail = n(m.element.rail("x"))),
                    r.appendChild(this.scrollbarXRail),
                    (this.scrollbarX = n(m.element.thumb("x"))),
                ...
                (this.scrollbarXBottom = parseInt(c.bottom, 10)),
                    ...
                    (this.scrollbarYRail = n(m.element.rail("y"))),
                    r.appendChild(this.scrollbarYRail),
                    (this.scrollbarY = n(m.element.thumb("y"))),
                ...
                (this.scrollbarYRight = parseInt(f.right, 10)),
                    ...
                    (this.railBorderYWidth =
                        u(f.borderTopWidth) + u(f.borderBottomWidth)),
                    t(this.scrollbarYRail, { display: "block" }),
                    (this.railYMarginHeight =
                        u(f.marginTop) + u(f.marginBottom)),
