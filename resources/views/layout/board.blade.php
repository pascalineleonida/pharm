			...
			<div class="navbar-content scroll-div " >
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item pcoded-hasmenu">
					    <a href="{{route('admin.users')}}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-layout"></i></span><span class="pcoded-mtext">gestion clients</span></a>
					</li>
                    <li class="nav-item pcoded-hasmenu">
					    <a href="{{route('admin.category')}}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-layout"></i></span><span class="pcoded-mtext">gestion category</span></a>
					</li>
                    <li class="nav-item pcoded-hasmenu">
					    <a href="{{route('admin.produit')}}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-layout"></i></span><span class="pcoded-mtext">gestion produit</span></a>
					</li>
					<li class="nav-item pcoded-menu-caption">
